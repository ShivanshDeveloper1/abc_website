  ...
  const AdminQuizEditor = () => {
    ...
    // Feature: Add a completely new question template to the quiz
    ...
    // Feature: Remove a question from the editing list
    ...
    const handleImageUpload = async (qIndex, file) => {
      ...
      setUploadingImageIndex(qIndex); // Track which question is uploading

      const formData = new FormData();
      formData.append('file', file);
      formData.append('upload_preset', 'ABC_TestSeries_image'); 
              ...
              <div className="space-y-6">
                {selectedQuiz.questions?.map((question, qIndex) => (
                  <div key={question._id || qIndex} className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 relative group">
                    ...
                    {/* Top Panel: Question Meta Data and Actions */}
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <input 
                          ...
                          className="bg-gray-50 border border-gray-300 rounded-lg px-3 py-1.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-red-500 bg-white"
                    ...
                    {/* Options Input Grid */}
                    <div className="mb-4">
                      <label className="block text-xs font-bold text-gray-500 uppercase mb-2">Options (Select radio button for the correct choice)</label>
                    ...
                    <div className="mt-4">
                      ...
                      <textarea
                        ...
                        placeholder="Provide helpful hints or rationales explaining why the chosen answer is accurate..."
                        rows={2}
                      />
                    </div>
